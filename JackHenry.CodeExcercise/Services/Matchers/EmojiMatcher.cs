...
namespace JackHenry.CodeExercise.App.Services.Matchers
{
    public class EmojiMatcher : Matcher, IEmojiMatcher
    {
        ...
        public override Task<List<string>> Match(string input)
        {
            ...
            var emojis = matches.Select(m => m.Value);

            return Task.FromResult(emojis.ToList());
        }
    }
}
